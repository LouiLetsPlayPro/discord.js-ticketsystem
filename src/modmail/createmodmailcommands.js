    ...
    client.on('ready', async() => {
        ...
        try{
            ...
            for (let i = 0; i < commands.map(c => c).length; i++) {
                ...
                /*if(commands.map(c => c)[i].name == "setupreport"){
            ...
            if(!commands.find(c => c.name == "modmailsetup")){
                client.application.commands.create({
                    name:"modmailsetup",
                    description:"Richte das Modmail System ein",
                    description_Localizations:"de",
                    dmPermission:false,
                    type:discord.ApplicationCommandType.ChatInput,
                ...
                commandcreatetable.push({name:"modmailsetup",neu:true})
            }
